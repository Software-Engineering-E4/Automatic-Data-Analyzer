...
public class main
{
    ...
    public static void main(String[] args) throws SQLException {
        ...
        //Connection con = DriverManager.getConnection("jdbc:mysql://ip-database.ccrihfbatmnt.eu-central-1.rds.amazonaws.com:3306/ipdatabase", "admin", "6kT4Yi1S7AtqErWTxZyD");
        ...
        while( rs.next() ){
            ...
            // INSERT INTO reddit_posts(negative, neutral, positive) VALUES(  sentimentList.get(0),  sentimentList.get(1),  sentimentList.get(2) )
            System.out.println("\n***************************************************************************************************\n");
        }
